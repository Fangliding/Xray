...
将内部 Buffer 大小提升到 16384 以匹配 TLS record size 的最大值 我稍微检查了一下也该没有问题 作为比较 V2ray→2048 Xray→8192 SingBox/Meta→32768 而
...
会删掉 Freedom 以后会加的默认 Block 本地访问（你都用本 fork 了实在没必要）

但是暂时不会同步上游 观察这个新的 GEO matcher 的情况